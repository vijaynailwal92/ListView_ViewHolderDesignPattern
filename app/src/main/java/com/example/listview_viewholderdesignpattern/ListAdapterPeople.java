...
public class ListAdapterPeople extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            personViewHolder.textViewName = view.findViewById(R.id.textViewName);
            personViewHolder.textViewLastName = view.findViewById(R.id.textViewLastName);
            personViewHolder.textViewGender = view.findViewById(R.id.textViewGender);
            personViewHolder.textViewNationality = view.findViewById(R.id.textViewNationality);
